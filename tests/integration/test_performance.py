    ...
    def test_load_small(self, model):
        ...
        for parent_cnt in range(1, 6):
            ...
            for attribute_cnt in range(1, 11):
                parent[f"attribute_{attribute_cnt}"] = f'p_{parent_cnt}_attribute_{attribute_cnt}'
            ...
            for child_cnt in range(1, 11):
                ...
                for attribute_cnt in range(1, 11):
                    entity[f"attribute_{attribute_cnt}"] = f'e_{child_cnt}_attribute_{attribute_cnt}'
        ...
        first_parent = next(parent for parent in all_parents if parent['name'] == 'parent_1')
